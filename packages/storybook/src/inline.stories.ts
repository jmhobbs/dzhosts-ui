...
const itemStyles = 'background: var(--dzt-color-bg-subtle); border: 1px solid var(--dzt-color-border-default); border-radius: var(--dzt-radius-1); padding: var(--dzt-space-2) var(--dzt-space-3);';
